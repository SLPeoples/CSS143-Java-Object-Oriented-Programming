	...
	public class PolyDemoPanel extends JPanel {		
		...
		public Shape getRandShape() {
			...
			switch( ( int )(Math.random() * 4) ) {
				...
				case 0: 	retVal = new Circle(x,y,r,getRandColor());
							break;
				case 1: 	retVal = new Square(x,y, r,getRandColor());
							break;
				case 2: 	retVal = new PokeBall(x,y,r,getRandColor());
							break;
				case 3: 	retVal = new Kite(x,y,r,w,getRandColor());
							break;				
			}
			return retVal;
		}
