...
class TestingDriver extends JFrame {
	public class TestingPanel extends JPanel {		
		...
		public TestingPanel() {
			...
			Kite kite = new Kite(getRandInt(),getRandInt(),40,60, Color.BLUE);
			System.out.println("Kite info: "+kite.toString());
			Kite kite2 = new Kite(getRandInt(),getRandInt(),60,40, Color.CYAN);
			System.out.println("KiteNC: "+kite2.toString());
