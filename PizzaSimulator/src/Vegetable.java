...
public class Vegetable extends Ingredient{
	...
	public static void main(String args[]){
		...
		Vegetable notEmptyColored1 = new Vegetable("notEmptyColored",new Money(4,125), 900, Color.BLACK);
		Vegetable notEmptyColored2 = new Vegetable("notEmptyColored",new Money(4,125), 900, Color.BLACK);
		System.out.println(empty.toString()+"\n"+notEmpty.toString()+"\n" +notEmptyColored1.toString()+"\n");
		empty.setColor(Color.RED);
		System.out.println(empty.toString()+"\n"+notEmpty.toString()+"\n" +notEmptyColored1.toString()+"\n");
		System.out.println(empty.getColor()+", "+notEmpty.getColor()+", "+notEmptyColored1.getColor()+"\n");
		System.out.println(empty.equals(notEmpty)+"\n" +notEmptyColored1.equals(notEmptyColored2));
	}
